            ...
            <div className="desktop9-container">
              ...
              <div className="desktop9-desktop9">
                ...
                <div className="desktop9-frame12">
                  ...
                  <span className="desktop9-text01">{client_address}</span>
                </div>
                <div className="desktop9-frame26">
                  ...
                  <div className="desktop9-frame25">
                    <div className="desktop9-container1">
                      <span className="desktop9-text03">Your fee from referral: {money}  matic</span>

                      <div className="desktop9-frame191"></div>
                    </div>
                    <div className="desktop9-container2">
                      <div className="desktop9-container3">
                        <button className="desktop9-button button" onClick = {retire_r}>Claim</button>
                      </div>
                    </div>
                  </div>
                </div>
                ...
                <div className="desktop9-frame4273195851">
                  ...
                  <div>
                        ...
                        <input
                          ...
                          id= "_ID_url" value = {_ID_url}
                        />
                        { check1 == false &&
                             <img className = "check_img" id ="my image" src={ok} alt="ok"/>
                         }

                         { check1 == true &&
                             <img   className = "check_img" id ="my image" src={not} alt="ok"  />
                         }
                  ...
                  <button className="desktop9-button1 button" onClick = {returndata}>    Mint   </button>

                        {nft_cost &&
                            <div className = "whitetext">
                                NFT COST: {nft_cost} matic
                            </div>
                          }
